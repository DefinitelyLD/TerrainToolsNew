...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Glow Emissive (Layered)"
{
	Properties
	{
		[StyledMessage(Info, Use the Emissive elements to dampen the emissive effect on vegetation or static props. Make sure the element size matches your terrain., 0,15)]_ElementMessage("Element Message", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 temp_output_9_0_g22336 = ( tex2D( _ControlTex1, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_0 );
				half Control_Max299_g22333 = _ControlMaskRemap.y;
				half4 ControlTex_1123_g22333 = saturate( ( ( temp_output_9_0_g22336 / ( Control_Max299_g22333 - temp_output_7_0_g22336 ) ) + 0.0001 ) );
				half4 weightedBlendVar16_g22333 = ControlTex_1123_g22333;
				half4 weightedBlend16_g22333 = ( weightedBlendVar16_g22333.x*_LayerColor1 + weightedBlendVar16_g22333.y*_LayerColor2 + weightedBlendVar16_g22333.z*_LayerColor3 + weightedBlendVar16_g22333.w*_LayerColor4 );
				half4 Terrain_Colors_118_g22333 = weightedBlend16_g22333;
				half temp_output_7_0_g22337 = Control_Min296_g22333;
				half4 temp_cast_1 = (temp_output_7_0_g22337).xxxx;
				half4 temp_output_9_0_g22337 = ( tex2D( _ControlTex2, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_1 );
				half4 ControlTex_2124_g22333 = saturate( ( ( temp_output_9_0_g22337 / ( Control_Max299_g22333 - temp_output_7_0_g22337 ) ) + 0.0001 ) );
				half4 weightedBlendVar15_g22333 = ControlTex_2124_g22333;
				half4 weightedBlend15_g22333 = ( weightedBlendVar15_g22333.x*_LayerColor5 + weightedBlendVar15_g22333.y*_LayerColor6 + weightedBlendVar15_g22333.z*_LayerColor7 + weightedBlendVar15_g22333.w*_LayerColor8 );
				half4 Terrain_Colors_217_g22333 = weightedBlend15_g22333;
				half temp_output_7_0_g22335 = Control_Min296_g22333;
				half4 temp_cast_2 = (temp_output_7_0_g22335).xxxx;
				half4 temp_output_9_0_g22335 = ( tex2D( _ControlTex3, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_2 );
				half4 ControlTex_3307_g22333 = saturate( ( ( temp_output_9_0_g22335 / ( Control_Max299_g22333 - temp_output_7_0_g22335 ) ) + 0.0001 ) );
				half4 weightedBlendVar339_g22333 = ControlTex_3307_g22333;
				half4 weightedBlend339_g22333 = ( weightedBlendVar339_g22333.x*_LayerColor9 + weightedBlendVar339_g22333.y*_LayerColor10 + weightedBlendVar339_g22333.z*_LayerColor11 + weightedBlendVar339_g22333.w*_LayerColor12 );
				half4 Terrain_Colors_3340_g22333 = weightedBlend339_g22333;
				half temp_output_7_0_g22334 = Control_Min296_g22333;
				half4 temp_cast_3 = (temp_output_7_0_g22334).xxxx;
				half4 temp_output_9_0_g22334 = ( tex2D( _ControlTex4, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_3 );
				half4 ControlTex_4322_g22333 = saturate( ( ( temp_output_9_0_g22334 / ( Control_Max299_g22333 - temp_output_7_0_g22334 ) ) + 0.0001 ) );
				half4 weightedBlendVar344_g22333 = ControlTex_4322_g22333;
				half4 weightedBlend344_g22333 = ( weightedBlendVar344_g22333.x*_LayerColor13 + weightedBlendVar344_g22333.y*_LayerColor14 + weightedBlendVar344_g22333.z*_LayerColor15 + weightedBlendVar344_g22333.w*_LayerColor16 );
				half4 Terrain_Colors_4350_g22333 = weightedBlend344_g22333;
				half4 Terrain_colors32_g22333 = ( Terrain_Colors_118_g22333 + Terrain_Colors_217_g22333 + Terrain_Colors_3340_g22333 + Terrain_Colors_4350_g22333 );
				...
				half temp_output_9_0_g22346 = ( TVE_SeasonLerp - temp_output_7_0_g22346 );
				half TVE_SeasonLerp57_g22333 = saturate( saturate( ( temp_output_9_0_g22346 / ( _SeasonRemap.y - temp_output_7_0_g22346 ) ) ) );
				...
				half temp_output_9_0_g22349 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g22349 );
				half lerpResult18_g22347 = lerp( 1.0 , saturate( ( temp_output_9_0_g22349 / ( _ElementVolumeFadeValue - temp_output_7_0_g22349 ) ) ) , _ElementVolumeFadeMode);
				half Element_Intensity235_g22333 = ( _ElementIntensity * Element_Inflience461_g22333 * lerpResult18_g22347 );
				half4 appendResult410_g22333 = (half4((Terrain_colors32_g22333).rgb , ( Terrain_colors32_g22333.a * Element_Intensity235_g22333 )));
				
				
				finalColor = appendResult410_g22333;
				return finalColor;
			}
			ENDCG
		}
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Terrain_Colors_4350_g22333 = weightedBlend344_g22333;
				half4 Terrain_colors32_g22333 = ( Terrain_Colors_118_g22333 + Terrain_Colors_217_g22333 + Terrain_Colors_3340_g22333 + Terrain_Colors_4350_g22333 );
				half3 Input_Color94_g22338 = (Terrain_colors32_g22333).rgb;
				half3 Element_Valid47_g22338 = Input_Color94_g22338;
				half TVE_SeasonOptions_X66_g22333 = TVE_SeasonOption.x;
				half Additional_Value_Winter90_g22333 = _AdditionalValue1;
				half Additional_Value_Spring88_g22333 = _AdditionalValue2;
				half temp_output_7_0_g22346 = _SeasonRemap.x;
				...
				half lerpResult18_g22347 = lerp( 1.0 , saturate( ( temp_output_9_0_g22349 / ( _ElementVolumeFadeValue - temp_output_7_0_g22349 ) ) ) , _ElementVolumeFadeMode);
				half Element_Intensity235_g22333 = ( _ElementIntensity * Element_Inflience461_g22333 * lerpResult18_g22347 );
				half Input_Alpha48_g22338 = ( Terrain_colors32_g22333.a * Element_Intensity235_g22333 );
				half4 appendResult58_g22338 = (half4(Element_Valid47_g22338 , Input_Alpha48_g22338));
				
				
				finalColor = appendResult58_g22338;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.FunctionNode;124;-640,-1152;Inherit;False;Element Glow;1;;22330;3d1b37ca7ef3f9c4f9ae756ac35720e3;0;0;1;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;119;-64,-1408;Inherit;False;Element Compile;-1;;22332;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;123;-384,-1152;Inherit;False;Element Terrain;10;;22333;a84c2b02263ac4b42be9eb75f696cb74;6,222,0,558,0,557,0,225,0,582,1,589,1;1;609;FLOAT;1;False;2;FLOAT4;230;FLOAT4;550
Node;AmplifyShaderEditor.RangedFloatNode;111;-640,-1408;Half;False;Property;_ElementMessage;Element Message;0;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Emissive elements to dampen the emissive effect on vegetation or static props. Make sure the element size matches your terrain., 0,15);False;0;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;120;-64,-1152;Half;False;True;-1;2;TheVisualEngine.ElementGUI;100;13;BOXOPHOBIC/The Visual Engine/Elements/Glow Emissive (Layered);f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;True;True;True;False;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
WireConnection;123;609;124;4
WireConnection;121;0;123;550
WireConnection;120;0;123;230
ASEEND*/
//CHKSM=D9DDAD8128A79F5111F6CD46BDB43AC930472E16