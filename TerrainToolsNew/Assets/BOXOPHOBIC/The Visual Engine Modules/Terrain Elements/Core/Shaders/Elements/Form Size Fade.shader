	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 temp_output_9_0_g23047 = ( tex2D( _ControlTex1, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_0 );
				half Control_Max299_g23044 = _ControlMaskRemap.y;
				half4 ControlTex_1123_g23044 = saturate( ( ( temp_output_9_0_g23047 / ( Control_Max299_g23044 - temp_output_7_0_g23047 ) ) + 0.0001 ) );
				...
				half4 temp_output_9_0_g23048 = ( tex2D( _ControlTex2, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_1 );
				half4 ControlTex_2124_g23044 = saturate( ( ( temp_output_9_0_g23048 / ( Control_Max299_g23044 - temp_output_7_0_g23048 ) ) + 0.0001 ) );
				...
				half4 temp_output_9_0_g23046 = ( tex2D( _ControlTex3, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_2 );
				half4 ControlTex_3307_g23044 = saturate( ( ( temp_output_9_0_g23046 / ( Control_Max299_g23044 - temp_output_7_0_g23046 ) ) + 0.0001 ) );
				...
				half4 temp_output_9_0_g23045 = ( tex2D( _ControlTex4, ( 1.0 - i.ase_texcoord1.xy ) ) - temp_cast_3 );
				half4 ControlTex_4322_g23044 = saturate( ( ( temp_output_9_0_g23045 / ( Control_Max299_g23044 - temp_output_7_0_g23045 ) ) + 0.0001 ) );
				...
				half temp_output_9_0_g23057 = ( TVE_SeasonLerp - temp_output_7_0_g23057 );
				half TVE_SeasonLerp57_g23044 = saturate( saturate( ( temp_output_9_0_g23057 / ( _SeasonRemap.y - temp_output_7_0_g23057 ) ) ) );
				...
				half temp_output_9_0_g23060 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23060 );
				half lerpResult18_g23058 = lerp( 1.0 , saturate( ( temp_output_9_0_g23060 / ( _ElementVolumeFadeValue - temp_output_7_0_g23060 ) ) ) , _ElementVolumeFadeMode);
...
ASEEND*/
//CHKSM=CB7177BD8E4CDB9FC5FB185D9D9F3AB6FA1E4149