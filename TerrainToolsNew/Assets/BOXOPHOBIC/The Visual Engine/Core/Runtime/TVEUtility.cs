...
namespace TheVisualEngine
{
    public class TVEUtils
    {
        ...
        public static void SetMaterialSettings(Material material)
        {
            ...
            if (material.HasProperty("_IsVersion"))
            {
                ...
                if (version < 1400)
                {
                    ...
                    if (pivotsMode == 0)
                    {
                        ...
                        material.SetFloat("_MotionBasePivotValue", GetMaterialSerializedFloat(material, "_MotionPosition_10", 0.5f));
                        material.SetFloat("_MotionBaseTillingValue", GetMaterialSerializedFloat(material, "_MotionScale_10", 5));
                        material.SetFloat("_MotionBaseSpeedValue", GetMaterialSerializedFloat(material, "_MotionSpeed_10", 5));

                        material.SetFloat("_MotionSmallPivotValue", 0.0f);
                        material.SetFloat("_MotionSmallTillingValue", GetMaterialSerializedFloat(material, "_MotionScale_20", 5));
                        material.SetFloat("_MotionSmallSpeedValue", GetMaterialSerializedFloat(material, "_MotionSpeed_20", 5));
                    }
                    ...
                    material.SetFloat("_MotionTinyTillingValue", GetMaterialSerializedFloat(material, "_MotionScale_32", 20.0f) * 2.5f);
                    material.SetFloat("_MotionTinySpeedValue", GetMaterialSerializedFloat(material, "_MotionSpeed_32", 20.0f) * 0.5f);
                ...
                if (version < 2050)
                {
                    ...
                    {
                        material.SetFloat("_ConformHeightValue", GetMaterialSerializedFloat(material, "_BlanketConformValue", 0f));
                        material.SetFloat("_ConformHeightOffsetValue", GetMaterialSerializedFloat(material, "_BlanketConformOffsetValue", 0f));
                        material.SetFloat("_ConformHeightOffsetMode", GetMaterialSerializedFloat(material, "_BlanketConformOffsetMode", 1f));
                        material.SetFloat("_ConformNormalValue", GetMaterialSerializedFloat(material, "_BlanketOrientationValue", 0f));
                    }

                    if (shaderName.Contains("Terrain"))
                    {
                        material.SetFloat("_ConformHeightValue", GetMaterialSerializedFloat(material, "_LandscapeHeightValue", 0f));
                        material.SetFloat("_ConformHeightMode", 0);
                    }

                    material.SetFloat("_TerrainFormValue", GetMaterialSerializedFloat(material, "_TerrainLandValue", 0f));
                    material.SetFloat("_TerrainFormMode", GetMaterialSerializedFloat(material, "_TerrainLandMode", 1f));
                    material.SetFloat("_TerrainFormOffsetValue", GetMaterialSerializedFloat(material, "_TerrainLandOffsetValue", 1f));

                    material.SetFloat("_NormalConformValue", GetMaterialSerializedFloat(material, "_NormalBlanketValue", 0f));
                    material.SetFloat("_NormalFormValue", GetMaterialSerializedFloat(material, "_NormalLandValue", 0f));
                    material.SetFloat("_NormalFormMode", GetMaterialSerializedFloat(material, "_NormalLandMode", 1f));
                    material.SetFloat("_NormalFormOffsetValue", GetMaterialSerializedFloat(material, "_NormalLandOffsetValue", 1f));
                    ...
                    material.SetFloat("_GlobalFlowLayerValue", GetMaterialSerializedFloat(material, "_MotionPushLayerValue", 0f));
                    material.SetFloat("_GlobalFlowPivotValue", GetMaterialSerializedFloat(material, "_MotionPushPivotValue", 1f));
                    ...
                    if (shaderName.Contains("Blanket") || shaderName.Contains("Terrain"))
                    {
                        for (int i = 1; i < 17; i++)
                        {
                            var layerRemapMin = GetMaterialSerializedVector(material, "_TerrainShaderMin" + i, new Vector4(0, 0, 0, 0));
                            var layerRemapMax = GetMaterialSerializedVector(material, "_TerrainShaderMax" + i, new Vector4(1, 1, 1, 1));
            ...
            SetMaterialOptions(material, "_ConformMeshMode", "_conform_vert_mode");
            ...
            SetMaterialReciprocal(material, "_TerrainBaseRemap");
            SetMaterialReciprocal(material, "_TerrainMaskRemap");
            SetMaterialReciprocal(material, "_TerrainProjRemap");
            SetMaterialReciprocal(material, "_TerrainMeshRemap");
            SetMaterialReciprocal(material, "_TerrainBlendRemap");
            SetMaterialReciprocal(material, "_OcclusionMeshRemap");
            SetMaterialReciprocal(material, "_GradientMeshRemap");
            SetMaterialReciprocal(material, "_VariationNoiseRemap");
            SetMaterialReciprocal(material, "_TintingLumaRemap");
            SetMaterialReciprocal(material, "_TintingMeshRemap");
            SetMaterialReciprocal(material, "_TintingBlendRemap");
            SetMaterialReciprocal(material, "_DrynessLumaRemap");
            SetMaterialReciprocal(material, "_DrynessMeshRemap");
            SetMaterialReciprocal(material, "_DrynessBlendRemap");
            ...
            SetMaterialReciprocal(material, "_OverlayBlendRemap");
            SetMaterialReciprocal(material, "_SeasonLumaRemap");
            SetMaterialReciprocal(material, "_WetnessWaterMeshRemap");
            SetMaterialReciprocal(material, "_WetnessWaterBlendRemap");
            SetMaterialReciprocal(material, "_WetnessDropsMeshRemap");
            SetMaterialReciprocal(material, "_CutoutMeshRemap");
            SetMaterialReciprocal(material, "_EmissiveMaskRemap");
            SetMaterialReciprocal(material, "_EmissiveMeshRemap");
            SetMaterialReciprocal(material, "_RimLightRemap");
            ...
            SetMaterialReciprocal(material, "_MotionPushMaskRemap");
            SetMaterialReciprocal(material, "_NormalProjRemap");
            SetMaterialReciprocal(material, "_NormalMeshRemap");
            SetMaterialReciprocal(material, "_ConformMeshRemap");

            SetMaterialFloat(material, "_ImpostorAlphaClipValue", "_AI_Clip");
            //SetMaterialFloat(material, "_MotionBasePhaseValue", "_motion_push_phase_value");
            ...
            SetMaterialKeyword(material, "_ObjectCoordMode", "TVE_COORD_ZUP");
            ...
            SetMaterialKeyword(material, "_TerrainIntensityValue", "_TerrainMaskSampleMode", new string[] { "TVE_TERRAIN_MASK_SAMPLE_MAIN_UV", "TVE_TERRAIN_MASK_SAMPLE_EXTRA_UV", "TVE_TERRAIN_MASK_SAMPLE_PLANAR_2D", "TVE_TERRAIN_MASK_SAMPLE_PLANAR_3D" });
            SetMaterialKeyword(material, "_TerrainIntensityValue", "_TerrainElementMode", "TVE_TERRAIN_ELEMENT");
            ...
            SetMaterialKeyword(material, "_TintingIntensityValue", "_TintingElementMode", "TVE_TINTING_ELEMENT");

            SetMaterialKeyword(material, "_DrynessIntensityValue", "TVE_DRYNESS");
            SetMaterialKeyword(material, "_DrynessIntensityValue", "_DrynessShiftValue", "TVE_DRYNESS_SHIFT");
            SetMaterialKeyword(material, "_DrynessIntensityValue", "_DrynessElementMode", "TVE_DRYNESS_ELEMENT");
            ...
            SetMaterialKeyword(material, "_OverlayIntensityValue", "_OverlayGlitterIntensityValue", "TVE_OVERLAY_GLITTER");
            SetMaterialKeyword(material, "_OverlayIntensityValue", "_OverlayElementMode", "TVE_OVERLAY_ELEMENT");

            SetMaterialKeyword(material, "_SeasonIntensityValue", "TVE_SEAOSON");

            SetMaterialKeyword(material, "_WetnessIntensityValue", "TVE_WETNESS");
            SetMaterialKeyword(material, "_WetnessIntensityValue", "_WetnessWaterIntensityValue", "TVE_WETNESS_WATER");
            SetMaterialKeyword(material, "_WetnessIntensityValue", "_WetnessDropsIntensityValue", "TVE_WETNESS_DROPS");
            //SetMaterialKeyword(material, new string[] { "_WetnessMeshValue", "_WetnessWaterMeshValue", "_WetnessDropsMeshValue" }, "TVE_WETNESS_VERT");
            SetMaterialKeyword(material, "_WetnessIntensityValue", "_WetnessElementMode", "TVE_WETNESS_ELEMENT");

            SetMaterialKeyword(material, "_CutoutIntensityValue", "TVE_CUTOUT");
            SetMaterialKeyword(material, "_CutoutIntensityValue", "_CutoutShadowMode", "TVE_CUTOUT_SHADOW");
            SetMaterialKeyword(material, "_CutoutIntensityValue", "_CutoutElementMode", "TVE_CUTOUT_ELEMENT");
            ...
            SetMaterialKeyword(material, "_GlancingIntensityValue", "TVE_GLANCING");
            SetMaterialKeyword(material, "_GlancingIntensityValue", "_GlancingShadowMode", "TVE_GLANCING_SHADOW");
            ...
            SetMaterialKeyword(material, "_SizeFadeIntensityValue", "_SizeFadeElementMode", "TVE_SIZEFADE_ELEMENT");

            //SetMaterialKeyword(material, "_BlanketOrientationValue", "TVE_BLANKET_BENDING");
            //material.SetFloat("_BlanketElementMode", 1);

            SetMaterialKeyword(material, new string[] { "_ConformHeightValue", "_ConformNormalValue" }, "TVE_CONFORM");
            material.SetFloat("_ConformElementMode", 1);

            SetMaterialKeyword(material, "_MotionIntensityValue", "TVE_MOTION");
            SetMaterialKeyword(material, "_MotionIntensityValue", "_MotionElementMode", "TVE_MOTION_ELEMENT");

            SetMaterialKeyword(material, new string[] { "_NormalFlattenValue", "NormalSphereValue", "_NormalComputeValue", "_NormalConformValue" }, "TVE_NORMAL");
            ...
            if (material.HasProperty("_MotionSmallIntensityValue"))
            {
                ...
                if (value > 0)
                {
                    material.SetFloat("_motion_small_mode", 1);
                }
                else
                {
                    material.SetFloat("_motion_small_mode", 0);
                }
            }
            ...
            {
                var overrideMode = GetMaterialInt(material, "_MetaEnabledMode");

                if (overrideMode == 1)
                {
                    var metaMode = GetMaterialInt(material, "_MetaMode");

                    if (metaMode == 0)
                    {
                        SetMaterialVector(material, "_MainColor", "_MetaColor");
                        SetMaterialFloat(material, "_MainAlphaClipValue", "_MetaAlphaClipValue");
                        SetMaterialFloat(material, "_MainAlbedoValue", "_MetaAlbedoValue");
                        SetMaterialTexture(material, "_MainAlbedoTex", "_MetaAlbedoTex");
                        SetMaterialVector(material, "_main_coord_value", "_MetaCoordValue");

                        var uvMode = GetMaterialInt(material, "_MetaSampleMode");
                        ...
                        var secondMode = GetMaterialFloat(material, "_SecondIntensityValue");

                        if (secondMode > 0)
                        {
                            SetMaterialVector(material, "_SecondColor", "_MetaColor");
                            SetMaterialFloat(material, "_SecondAlphaClipValue", "_MetaAlphaClipValue");
                            SetMaterialFloat(material, "_SecondAlbedoValue", "_MetaAlbedoValue");
                            SetMaterialTexture(material, "_SecondAlbedoTex", "_MetaAlbedoTex");
                            SetMaterialVector(material, "_second_coord_value", "_MetaCoordValue");
                        }

                        var thirdMode = GetMaterialFloat(material, "_ThirdIntensityValue");

                        if (thirdMode > 0)
                        {
                            SetMaterialVector(material, "_ThirdColor", "_MetaColor");
                            SetMaterialFloat(material, "_ThirdAlphaClipValue", "_MetaAlphaClipValue");
                            SetMaterialFloat(material, "_ThirdAlbedoValue", "_MetaAlbedoValue");
                            SetMaterialTexture(material, "_ThirdAlbedoTex", "_MetaAlbedoTex");
                            SetMaterialVector(material, "_third_coord_value", "_MetaCoordValue");
                        }
                    }

                    var metaTinting = GetMaterialInt(material, "_MetaTintingMode");

                    if (metaTinting == 0)
                    {
                        SetMaterialFloat(material, "_TintingIntensityValue", "_MetaTintingValue");
                    }

                    var metaDryness = GetMaterialInt(material, "_MetaDrynessMode");

                    if (metaDryness == 0)
                    {
                        SetMaterialFloat(material, "_DrynessIntensityValue", "_MetaDrynessValue");
                    }

                    var metaOverlay = GetMaterialInt(material, "_MetaOverlayMode");

                    if (metaOverlay == 0)
                    {
                        SetMaterialFloat(material, "_OverlayIntensityValue", "_MetaOverlayValue");
                    }

                    var metaWetness = GetMaterialInt(material, "_MetaOverlayMode");

                    if (metaWetness == 0)
                    {
                        SetMaterialFloat(material, "_WetnessIntensityValue", "_MetaWetnessValue");
                    }

                    var metaCutout = GetMaterialInt(material, "_MetaCutoutMode");

                    if (metaCutout == 0)
                    {
                        SetMaterialFloat(material, "_CutoutIntensityValue", "_MetaCutoutValue");
                    }

                    var metaDither = GetMaterialInt(material, "_MetaDitherMode");

                    if (metaDither == 0)
                    {
                        SetMaterialFloat(material, "_DitherConstantValue", "_MetaDitherValue");
                    }

                    var metaEmissive = GetMaterialInt(material, "_MetaEmissiveMode");

                    if (metaEmissive == 0)
                    {
                        SetMaterialFloat(material, "_EmissiveIntensityValue", "_MetaEmissiveValue");
                    }
                }
            }
        ...
        public static void CopyTerrainDataToElement(Terrain terrain, TVETerrainTexture terrainMask, Material material)
        {
            if (terrain == null || terrain.terrainData == null || terrainMask == TVETerrainTexture.None)
            {
                ...
                material.SetInt("_ElementInputMode", 0);

                return;
            }

            material.SetInt("_ElementInputMode", 1);
        ...
        public static void CopyTerrainDataToMaterial(TVETerrain tveTerrain, Material material)
        {
            ...
            for (int i = 0; i < tveTerrain.terrain.terrainData.terrainLayers.Length; i++)
            {
                ...
                if (tveTerrain.terrainPropertyBlock.HasProperty("_TerrainShaderRcp"))
                {
                    material.SetVector("_TerrainShaderRcp", tveTerrain.terrainPropertyBlock.GetVector("_TerrainShaderRcp"));
                }
        ...
        public static Color GetGlobalTextureData(string globalTexture, Vector3 position, int layer, Texture2DArray texture2DArray)
        {
            ...
            var volumePosition = tveManager.elementRenderer.baseCenter.position;
            var volumeScale = new Vector3(tveManager.elementRenderer.baseRadius * 2f, 100000, tveManager.elementRenderer.baseRadius * 2f);

            if (globalTexture.Contains("Near"))
            {
                volumeScale = new Vector3(tveManager.elementRenderer.nearRadius * 2f, 100000, tveManager.elementRenderer.nearRadius * 2f);
            }
        ...
        public static void SetShaderSettings(string shaderPath, TVEShaderSettings shaderSettings)
        {
            ...
            {
                cgincInfiniteLandsRenderer = TVEUtils.FindAsset("GrassInstanced.hlsl");
            }
                ...
                if (inputObject.GetType() == typeof(GameObject))
                {
                    ...
                    if (gameObject.GetComponent<TVETerrain>() != null)
                    {
                        ...
                        if (terrain.terrainPropertyBlock != null)
                        {
                            ...
                            {
                                CopyTerrainDataToMaterial(terrain, material);
                            }
                            else
                            {
        ...
        public static void SetActiveDisplay(int offset, string color, GUIStyle subTitleStyle)
        {
            ...
            GUI.Label(subRect, "<size=9>" + subtitle + "</size>", subTitleStyle);
        }
#endif
        ...
        {
            var folder = TVEUtils.FindAsset("Boxophobic+.pdf");
    ...
    public class TVEGlobalCoatData
    {
        ...
        //[Tooltip("Controls the global Extra intensity.")]
        //[Range(0.0f, 1.0f)]
        //public float extraIntensity = 1.0f;
