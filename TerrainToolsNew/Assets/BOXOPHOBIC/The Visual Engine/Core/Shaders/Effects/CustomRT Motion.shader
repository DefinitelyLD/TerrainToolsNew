	...
	SubShader
	{
        ...
        Pass
        {
            ...
            float4 frag(ase_v2f_customrendertexture IN ) : COLOR
            {
                ...
                finalColor = appendResult188_g77191;
				return finalColor;
            }
            ENDCG
		}
