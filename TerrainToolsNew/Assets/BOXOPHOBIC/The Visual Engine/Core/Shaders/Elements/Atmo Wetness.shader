...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g24354 = _SeasonRemap.x;
				half temp_output_9_0_g24354 = ( TVE_SeasonLerp - temp_output_7_0_g24354 );
				half TVE_SeasonLerp54_g24346 = saturate( saturate( ( temp_output_9_0_g24354 / ( _SeasonRemap.y - temp_output_7_0_g24354 ) ) ) );
				...
				half2 vertexToFrag11_g24361 = ( ( lerpResult1899_g24346 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g24361;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24361 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g24346 = tex2D( _MainTex, vertexToFrag11_g24361 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24355 = clamp( (MainTex_RGBA587_g24346).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24353 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24353).xxx;
				half3 temp_output_9_0_g24353 = ( clampResult17_g24355 - temp_cast_2 );
				half3 temp_output_1765_0_g24346 = saturate( ( temp_output_9_0_g24353 / ( _MainTexColorRemap.y - temp_output_7_0_g24353 ) ) );
				...
				half clampResult17_g24356 = clamp( (MainTex_RGBA587_g24346).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24352 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24352 = ( clampResult17_g24356 - temp_output_7_0_g24352 );
				half Element_Remap_A74_g24346 = saturate( ( ( temp_output_9_0_g24352 / ( _MainTexAlphaRemap.y - temp_output_7_0_g24352 ) ) + 0.0001 ) );
				half Element_Params_A1737_g24346 = _ElementParams_Instance.w;
				half clampResult17_g24350 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g24351 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g24351 = ( clampResult17_g24350 - temp_output_7_0_g24351 );
				half Element_Falloff1883_g24346 = saturate( ( ( temp_output_9_0_g24351 / ( _MainTexFalloffRemap.y - temp_output_7_0_g24351 ) ) + 0.0001 ) );
				half temp_output_7_0_g24360 = 1.0;
				half temp_output_9_0_g24360 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24360 );
				half lerpResult18_g24358 = lerp( 1.0 , saturate( ( temp_output_9_0_g24360 / ( _ElementVolumeFadeValue - temp_output_7_0_g24360 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24346 = ( _ElementIntensity * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * lerpResult18_g24358 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Tint76_g76854 = (color1873_g24346).rgb;
				...
				half Element_Alpha56_g24346 = ( _ElementIntensity * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * lerpResult18_g24358 );
				half Final_Extras_A241_g24346 = Element_Alpha56_g24346;
				half Input_Alpha48_g76854 = Final_Extras_A241_g24346;
...
Node;AmplifyShaderEditor.FunctionNode;173;0,-1280;Inherit;False;Element Shader;10;;24346;0e972c73cae2ee54ea51acc9738801d0;12,477,1,1778,1,478,0,1824,0,1814,1,145,1,1784,0,481,0,1933,1,1935,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;142;320,-1280;Half;False;True;-1;2;TheVisualEngine.ElementGUI;100;13;BOXOPHOBIC/The Visual Engine/Elements/Atmo Wetness;f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;False;True;False;False;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
...
ASEEND*/
//CHKSM=9A5B2C36C627B9B22C41130566235E8546A4CA37