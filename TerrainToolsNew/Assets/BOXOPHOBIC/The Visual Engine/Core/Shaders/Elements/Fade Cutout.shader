...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFadeCutout
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23502 = _SeasonRemap.x;
				half temp_output_9_0_g23502 = ( TVE_SeasonLerp - temp_output_7_0_g23502 );
				half TVE_SeasonLerp54_g23494 = saturate( saturate( ( temp_output_9_0_g23502 / ( _SeasonRemap.y - temp_output_7_0_g23502 ) ) ) );
				...
				half2 appendResult1900_g23494 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult1899_g23494 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g23494 , _ElementUVsMode);
				half2 vertexToFrag11_g23509 = ( ( lerpResult1899_g23494 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23509;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23509 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23494 = tex2D( _MainTex, vertexToFrag11_g23509 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23503 = clamp( (MainTex_RGBA587_g23494).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23501 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23501).xxx;
				half3 temp_output_9_0_g23501 = ( clampResult17_g23503 - temp_cast_2 );
				...
				half clampResult17_g23504 = clamp( (MainTex_RGBA587_g23494).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23500 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23500 = ( clampResult17_g23504 - temp_output_7_0_g23500 );
				...
				half temp_output_7_0_g23508 = 1.0;
				half temp_output_9_0_g23508 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23508 );
				half lerpResult18_g23506 = lerp( 1.0 , saturate( ( temp_output_9_0_g23508 / ( _ElementVolumeFadeValue - temp_output_7_0_g23508 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23494 = ( _ElementIntensity * Element_Remap_A74_g23494 * Element_Params_A1737_g23494 * i.ase_color.a * Element_Falloff1883_g23494 * lerpResult18_g23506 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFadeCutout
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Tint76_g76856 = (color1875_g23494).rgb;
				...
				half Input_Alpha48_g76856 = Final_Extras_A241_g23494;
...
ASEEND*/
//CHKSM=11A69EA3AC05010DCCAB09151E4BEF18398EEC91