...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintMap
			...
			v2f vert ( appdata v )
			{
				...
				half2 appendResult1900_g24794 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult1899_g24794 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g24794 , _ElementUVsMode);
				half2 vertexToFrag11_g24809 = ( ( lerpResult1899_g24794 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.xy = vertexToFrag11_g24809;
				...
				half temp_output_7_0_g24802 = _SeasonRemap.x;
				half temp_output_9_0_g24802 = ( TVE_SeasonLerp - temp_output_7_0_g24802 );
				half TVE_SeasonLerp54_g24794 = saturate( saturate( ( temp_output_9_0_g24802 / ( _SeasonRemap.y - temp_output_7_0_g24802 ) ) ) );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24809 = i.ase_texcoord1.xy;
				half4 MainTex_RGBA587_g24794 = tex2D( _MainTex, vertexToFrag11_g24809 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24803 = clamp( (MainTex_RGBA587_g24794).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24801 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24801).xxx;
				half3 temp_output_9_0_g24801 = ( clampResult17_g24803 - temp_cast_2 );
				half3 temp_output_1765_0_g24794 = saturate( ( temp_output_9_0_g24801 / ( _MainTexColorRemap.y - temp_output_7_0_g24801 ) ) );
				...
				half clampResult17_g24804 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24800 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24800 = ( clampResult17_g24804 - temp_output_7_0_g24800 );
				half Element_Remap_A74_g24794 = saturate( ( ( temp_output_9_0_g24800 / ( _MainTexAlphaRemap.y - temp_output_7_0_g24800 ) ) + 0.0001 ) );
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_A1737_g24794 = _ElementParams_Instance.w;
				half clampResult17_g24798 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord1.zw*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g24799 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g24799 = ( clampResult17_g24798 - temp_output_7_0_g24799 );
				half Element_Falloff1883_g24794 = saturate( ( ( temp_output_9_0_g24799 / ( _MainTexFalloffRemap.y - temp_output_7_0_g24799 ) ) + 0.0001 ) );
				half temp_output_7_0_g24808 = 1.0;
				half temp_output_9_0_g24808 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24808 );
				half lerpResult18_g24806 = lerp( 1.0 , saturate( ( temp_output_9_0_g24808 / ( _ElementVolumeFadeValue - temp_output_7_0_g24808 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24794 = ( _ElementIntensity * Element_Remap_A74_g24794 * Element_Params_A1737_g24794 * i.ase_color.a * Element_Falloff1883_g24794 * lerpResult18_g24806 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintMap
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Remap_RGB1555_g24794 = temp_output_1765_0_g24794;
				half3 Final_ColorsMap_RGB598_g24794 = ( (Color_Main_RGBA49_g24794).rgb * Element_Remap_RGB1555_g24794 );
				half3 Input_Color94_g76851 = Final_ColorsMap_RGB598_g24794;
				half3 Element_Valid47_g76851 = Input_Color94_g76851;
				half clampResult17_g24804 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24800 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24800 = ( clampResult17_g24804 - temp_output_7_0_g24800 );
				half Element_Remap_A74_g24794 = saturate( ( ( temp_output_9_0_g24800 / ( _MainTexAlphaRemap.y - temp_output_7_0_g24800 ) ) + 0.0001 ) );
				...
				half Element_Seasons834_g24794 = vertexToFrag11_g24797;
				half Final_ColorsMap_A603_g24794 = ( Element_Alpha56_g24794 * Element_Seasons834_g24794 );
				half Input_Alpha48_g76851 = Final_ColorsMap_A603_g24794;
				half4 appendResult58_g76851 = (half4(Element_Valid47_g76851 , Input_Alpha48_g76851));
				
				
				finalColor = appendResult58_g76851;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;139;-640,-640;Half;False;Property;_render_colormask;_render_colormask;72;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;158;-384,-384;Inherit;False;Element Shader;10;;24794;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,1,1824,1,1814,0,145,0,1784,0,481,0,1933,1,1935,1,1904,1,1907,1;1;1974;FLOAT;1;False;2;FLOAT4;0;FLOAT4;1779
Node;AmplifyShaderEditor.FunctionNode;152;-64,-768;Inherit;False;Element Compile;-1;;76863;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;153;-64,-384;Half;False;True;-1;2;TheVisualEngine.ElementGUI;100;13;BOXOPHOBIC/The Visual Engine/Elements/Paint Map;f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;154;-64,-256;Float;False;False;-1;2;AmplifyShaderEditor.MaterialInspector;100;13;New Amplify Shader;f4f273c3bb6262d4396be458405e60f9;True;VisualPass;0;1;VisualPass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;False;True;2;False;0;;0;0;Standard;0;False;0
WireConnection;158;1974;161;4
WireConnection;153;0;158;0
WireConnection;154;0;158;1779
ASEEND*/
//CHKSM=D9B5097C7DB22BF2F7B7E495833CD38C6A952F28