...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Form Size Slope (Model)"
{
	Properties
	{
		[StyledMessage(Info, Use the Size Slope elements to control the size based on the object element normal orientation., 0, 15)]_ElementMessage("Element Message", Float) = 0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-1536,-1408;Half;False;Property;_ElementMessage;Element Message;0;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Size Slope elements to control the size based on the object element normal orientation., 0, 15);False;0;0;1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=364C03D38DD41A1D8D3BF63575CEEDF83E3F1F35