...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Form Size Slope (Terrain)"
{
	Properties
	{
		[StyledMessage(Info, Use the Size Slope elements to control the size based on the terrain normal orientation., 0, 15)]_ElementMessage("Element Message", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g23063 = _ElementSlopeRemap.x;
				float temp_output_9_0_g23063 = ( clampResult17_g23057 - temp_output_7_0_g23063 );
				float Terrain_Slope243 = saturate( ( ( temp_output_9_0_g23063 / ( _ElementSlopeRemap.y - temp_output_7_0_g23063 ) ) + 0.0001 ) );
				...
				float lerpResult18_g23058 = lerp( 1.0 , saturate( ( temp_output_9_0_g23060 / ( _ElementVolumeFadeValue - temp_output_7_0_g23060 ) ) ) , _ElementVolumeFadeMode);
				float Element_Alpha196 = ( _ElementIntensity * lerpResult18_g23058 );
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23064 = temp_cast_0;
				float3 break68_g23064 = Input_Color94_g23064;
				float clampResult80_g23064 = clamp( max( max( break68_g23064.x , break68_g23064.y ) , break68_g23064.z ) , 0.1 , 10000.0 );
				float4 color234 = IsGammaSpace() ? float4(0,1,0,0) : float4(0,1,0,0);
				half3 Input_Tint76_g23064 = (color234).rgb;
				half3 Element_Valid47_g23064 = ( clampResult80_g23064 * Input_Tint76_g23064 );
				float temp_output_7_0_g23060 = 1.0;
				float temp_output_9_0_g23060 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23060 );
				float lerpResult18_g23058 = lerp( 1.0 , saturate( ( temp_output_9_0_g23060 / ( _ElementVolumeFadeValue - temp_output_7_0_g23060 ) ) ) , _ElementVolumeFadeMode);
				float Element_Alpha196 = ( _ElementIntensity * lerpResult18_g23058 );
				half Input_Alpha48_g23064 = Element_Alpha196;
				float4 appendResult58_g23064 = (float4(Element_Valid47_g23064 , Input_Alpha48_g23064));
				
				
				finalColor = appendResult58_g23064;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.Vector3Node;233;-1536,880;Half;False;Property;_ElementSlopeAxis;Element Slope Axis;14;0;Create;False;0;0;0;False;2;Space(10);StyledVector(18);False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;194;-1536,1216;Inherit;False;Element Fade Volume;18;;23058;4935729172cdadd45b9b14c3fa9c1db4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;217;-1536,1152;Inherit;False;Element Form;1;;23061;bc58488265c2ed6408843a733b1a9124;0;0;1;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;249;-384,640;Inherit;False;Math Remap;-1;;23063;5eda8a2bb94ebef4ab0e43d19291cd8b;2,18,0,14,0;4;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;19;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;202;1312,-320;Inherit;False;196;Element_Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;234;1312,-256;Inherit;False;Constant;_Color7;Color 1;63;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;244;1312,-384;Inherit;False;243;Terrain_Slope;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;203;1568,-384;Inherit;False;Element Visuals;-1;;23064;78cf0f00cfd72824e84597f2db54a76e;1,64,1;3;59;FLOAT3;0,0,0;False;117;FLOAT;0;False;77;COLOR;1,1,1,1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;176;-832,-1408;Inherit;False;Element Compile;-1;;23065;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-1536,-1408;Half;False;Property;_ElementMessage;Element Message;0;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Size Slope elements to control the size based on the terrain normal orientation., 0, 15);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;199;1984,-640;Float;False;True;-1;2;TheVisualEngine.ElementGUI;100;13;BOXOPHOBIC/The Visual Engine/Elements/Form Size Slope (Terrain);f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;0;5;False;_render_src;10;False;;1;0;True;_render_src;0;True;_render_dst;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;False;False;False;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
