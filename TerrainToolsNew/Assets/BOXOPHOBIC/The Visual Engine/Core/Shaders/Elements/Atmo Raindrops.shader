...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRaindrops
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g76854 = _SeasonRemap.x;
				half temp_output_9_0_g76854 = ( TVE_SeasonLerp - temp_output_7_0_g76854 );
				half TVE_SeasonLerp54_g76846 = saturate( saturate( ( temp_output_9_0_g76854 / ( _SeasonRemap.y - temp_output_7_0_g76854 ) ) ) );
				...
				half2 appendResult1900_g76846 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult1899_g76846 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g76846 , _ElementUVsMode);
				half2 vertexToFrag11_g76861 = ( ( lerpResult1899_g76846 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g76861;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g76861 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g76846 = tex2D( _MainTex, vertexToFrag11_g76861 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g76855 = clamp( (MainTex_RGBA587_g76846).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g76853 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g76853).xxx;
				half3 temp_output_9_0_g76853 = ( clampResult17_g76855 - temp_cast_2 );
				...
				half clampResult17_g76856 = clamp( (MainTex_RGBA587_g76846).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g76852 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g76852 = ( clampResult17_g76856 - temp_output_7_0_g76852 );
				...
				half temp_output_7_0_g76860 = 1.0;
				half temp_output_9_0_g76860 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g76860 );
				half lerpResult18_g76858 = lerp( 1.0 , saturate( ( temp_output_9_0_g76860 / ( _ElementVolumeFadeValue - temp_output_7_0_g76860 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g76846 = ( _ElementIntensity * Element_Remap_A74_g76846 * Element_Params_A1737_g76846 * i.ase_color.a * Element_Falloff1883_g76846 * lerpResult18_g76858 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRaindrops
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g76880 = temp_cast_3;
				half3 break68_g76880 = Input_Color94_g76880;
				half clampResult80_g76880 = clamp( max( max( break68_g76880.x , break68_g76880.y ) , break68_g76880.z ) , 0.1 , 10000.0 );
				half4 color1877_g76846 = IsGammaSpace() ? half4(0,1,0,0) : half4(0,1,0,0);
				half3 Input_Tint76_g76880 = (color1877_g76846).rgb;
				half3 Element_Valid47_g76880 = ( clampResult80_g76880 * Input_Tint76_g76880 );
				half clampResult17_g76856 = clamp( (MainTex_RGBA587_g76846).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g76852 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g76852 = ( clampResult17_g76856 - temp_output_7_0_g76852 );
				half Element_Remap_A74_g76846 = saturate( ( ( temp_output_9_0_g76852 / ( _MainTexAlphaRemap.y - temp_output_7_0_g76852 ) ) + 0.0001 ) );
				...
				half Input_Alpha48_g76880 = Final_Extras_A241_g76846;
				half4 appendResult58_g76880 = (half4(Element_Valid47_g76880 , Input_Alpha48_g76880));
				
				
				finalColor = appendResult58_g76880;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=207AC2D00F61A78A541226F0DF86CE8329350346