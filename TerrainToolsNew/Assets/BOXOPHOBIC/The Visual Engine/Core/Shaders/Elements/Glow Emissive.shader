...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsGlowEmissive
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_7_0_g23646 = _SeasonRemap.x;
				float temp_output_9_0_g23646 = ( TVE_SeasonLerp - temp_output_7_0_g23646 );
				...
				float2 vertexToFrag11_g23653 = ( ( lerpResult1899_g23638 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g23653;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 vertexToFrag11_g23653 = i.ase_texcoord2.xy;
				...
				float3 clampResult17_g23647 = clamp( (MainTex_RGBA587_g23638).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g23645 = _MainTexColorRemap.x;
				float3 temp_cast_2 = (temp_output_7_0_g23645).xxx;
				float3 temp_output_9_0_g23645 = ( clampResult17_g23647 - temp_cast_2 );
				float3 temp_output_1765_0_g23638 = saturate( ( temp_output_9_0_g23645 / ( _MainTexColorRemap.y - temp_output_7_0_g23645 ) ) );
				...
				float clampResult17_g23648 = clamp( (MainTex_RGBA587_g23638).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23644 = _MainTexAlphaRemap.x;
				float temp_output_9_0_g23644 = ( clampResult17_g23648 - temp_output_7_0_g23644 );
				...
				float clampResult17_g23642 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.zw*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g23643 = _MainTexFalloffRemap.x;
				float temp_output_9_0_g23643 = ( clampResult17_g23642 - temp_output_7_0_g23643 );
				half Element_Falloff1883_g23638 = saturate( ( ( temp_output_9_0_g23643 / ( _MainTexFalloffRemap.y - temp_output_7_0_g23643 ) ) + 0.0001 ) );
				float temp_output_7_0_g23652 = 1.0;
				float temp_output_9_0_g23652 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23652 );
				float lerpResult18_g23650 = lerp( 1.0 , saturate( ( temp_output_9_0_g23652 / ( _ElementVolumeFadeValue - temp_output_7_0_g23652 ) ) ) , _ElementVolumeFadeMode);
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsGlowEmissive
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Color1756_g23638 = ( Element_Remap_RGB1555_g23638 * Element_Params_RGB1735_g23638 * (i.ase_color).rgb );
				half3 Final_Colors_RGB142_g23638 = ( (lerpResult30_g23638).rgb * Element_Color1756_g23638 );
				half3 Input_Color94_g76850 = Final_Colors_RGB142_g23638;
				half3 Element_Valid47_g76850 = Input_Color94_g76850;
				float clampResult17_g23648 = clamp( (MainTex_RGBA587_g23638).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23644 = _MainTexAlphaRemap.x;
				float temp_output_9_0_g23644 = ( clampResult17_g23648 - temp_output_7_0_g23644 );
				half Element_Remap_A74_g23638 = saturate( ( ( temp_output_9_0_g23644 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23644 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g23638 = ( _ElementIntensity * Element_Remap_A74_g23638 * Element_Params_A1737_g23638 * i.ase_color.a * Element_Falloff1883_g23638 * lerpResult18_g23650 );
				half Final_Colors_A144_g23638 = ( (lerpResult30_g23638).a * Element_Alpha56_g23638 );
				half Input_Alpha48_g76850 = Final_Colors_A144_g23638;
				float4 appendResult58_g76850 = (float4(Element_Valid47_g76850 , Input_Alpha48_g76850));
				
				
				finalColor = appendResult58_g76850;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;142;-384,-1152;Inherit;False;Element Shader;10;;23638;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,0,1824,0,1814,0,145,0,1784,0,481,0,1933,1,1935,1,1904,1,1907,1;1;1974;FLOAT;1;False;2;FLOAT4;0;FLOAT4;1779
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;132;-64,-1152;Float;False;True;-1;2;TheVisualEngine.ElementGUI;100;13;BOXOPHOBIC/The Visual Engine/Elements/Glow Emissive;f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;True;True;True;False;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;133;-64,-1024;Float;False;False;-1;2;AmplifyShaderEditor.MaterialInspector;100;13;New Amplify Shader;f4f273c3bb6262d4396be458405e60f9;True;VisualPass;0;1;VisualPass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;False;True;2;False;0;;0;0;Standard;0;False;0
WireConnection;142;1974;144;4
WireConnection;132;0;142;0
WireConnection;133;0;142;1779
ASEEND*/
//CHKSM=16AC5869F2EB2CFDDCF0DA6234FDA6ED6CE9E506