...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Fade Slope (Terrain)"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g23068 = _ElementSlopeRemap.x;
				float temp_output_9_0_g23068 = ( clampResult17_g23057 - temp_output_7_0_g23068 );
				float Terrain_Slope243 = saturate( ( ( temp_output_9_0_g23068 / ( _ElementSlopeRemap.y - temp_output_7_0_g23068 ) ) + 0.0001 ) );
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23071 = temp_cast_0;
				float3 break68_g23071 = Input_Color94_g23071;
				float clampResult80_g23071 = clamp( max( max( break68_g23071.x , break68_g23071.y ) , break68_g23071.z ) , 0.1 , 10000.0 );
				float4 color263 = IsGammaSpace() ? float4(0.5,0.5,0.5,0) : float4(0.2140411,0.2140411,0.2140411,0);
				half3 Input_Tint76_g23071 = (color263).rgb;
				half3 Element_Valid47_g23071 = ( clampResult80_g23071 * Input_Tint76_g23071 );
				float temp_output_7_0_g23060 = 1.0;
				float temp_output_9_0_g23060 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23060 );
				float lerpResult18_g23058 = lerp( 1.0 , saturate( ( temp_output_9_0_g23060 / ( _ElementVolumeFadeValue - temp_output_7_0_g23060 ) ) ) , _ElementVolumeFadeMode);
				float Element_Alpha196 = ( _ElementIntensity * lerpResult18_g23058 );
				half Input_Alpha48_g23071 = Element_Alpha196;
				float4 appendResult58_g23071 = (float4(Element_Valid47_g23071 , Input_Alpha48_g23071));
				
				
				finalColor = appendResult58_g23071;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;249;-384,640;Inherit;False;Math Remap;-1;;23068;5eda8a2bb94ebef4ab0e43d19291cd8b;2,18,0,14,0;4;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;19;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;176;-832,-1408;Inherit;False;Element Compile;-1;;23070;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;203;1536,-384;Inherit;False;Element Visuals;-1;;23071;78cf0f00cfd72824e84597f2db54a76e;1,64,1;3;59;FLOAT3;0,0,0;False;117;FLOAT;0;False;77;COLOR;1,1,1,1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;199;1984,-640;Float;False;True;-1;2;TheVisualEngine.ElementGUI;100;13;BOXOPHOBIC/The Visual Engine/Elements/Fade Slope (Terrain);f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;0;5;False;_render_src;10;False;;1;0;True;_render_src;0;True;_render_dst;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;False;False;False;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
...
ASEEND*/
//CHKSM=21A1B8A4AA5F3B794CEDEA71D4B08740E7F9BF4D