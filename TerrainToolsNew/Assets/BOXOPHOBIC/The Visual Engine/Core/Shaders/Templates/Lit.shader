Shader /*ase_name*/ "Hidden/BOXOPHOBIC/The Visual Engine/Lit" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:  Refraction Model:None,Planar,Sphere,Thin:None
				...
				None,disable:RemoveDefine:pragma shader_feature_local_fragment _ _REFRACTION_PLANE _REFRACTION_SPHERE _REFRACTION_THIN
				...
				Planar,Sphere,Thin:SetDefine:pragma shader_feature_local_fragment _ _REFRACTION_PLANE _REFRACTION_SPHERE _REFRACTION_THIN
		...
		*/
		...
		Pass
		{
			...
			struct PackedVaryingsMeshToPS
			{
				...
				/*ase_interp(5,):sp=sp.xyzw;rwp=tc0.xyz;wn=tc1.xyz;wt=tc2;uv1=tc3;uv2=tc4*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
						...
						/*ase_frag_input*/ )
			{
				...
				/*ase_local_var:sp*/float4 ClipPos = TransformWorldToHClip( PositionRWS );
				...
				surfaceDescription.BakedBackGI = /*ase_frag_out:Baked Back GI;Float3;32;-1;_BakedBackGI*/0/*end*/;
					...
					posInput.positionWS = PositionRWS;
						...
						posInput.deviceDepth = /*ase_frag_out:Depth;Float;28;-1;_DeviceDepth*/input.positionSS.z/*end*/;
					#else
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(inout AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output/*ase_vert_input*/ )
			{
		...
		Pass
		{
			...
			struct PackedVaryingsMeshToPS
			{
				...
				#endif
				/*ase_interp(7,):sp=sp.xyzw;rwp=tc0.xyz;wn=tc1.xyz;wt=tc2;uv1=tc3;uv2=tc4*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
				#if defined(SHADER_STAGE_FRAGMENT) && defined(ASE_NEED_CULLFACE)
				FRONT_FACE_TYPE cullFace : FRONT_FACE_SEMANTIC;
