...
namespace TheVisualEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        {
        "All Material Settings", "Render Settings", "Surface Settings", "Terrain Settings", "Coloring Settings", "Season Settings", "Fading Settings", "Lighting Settings", "Transform Settings", "Motion Settings", "Normal Settings", "Meta Settings"
        };
        ...
        List<TVEPropertyData> surfaceData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_MainMultiMaskInfo", "Use the Multi Mask remap sliders to mask out the leaves when using Dual Colors or for Global Effects. The mask is stored in the Shader texture blue channel.", 0, 10, MessageType.Info),
            ...
            new TVEPropertyData("_SecondLumaValue", "Detail Luma Mask", -9000, 0, 1, false, false),
            new TVEPropertyData("_SecondLumaRemap", "Detail Luma Mask", new Vector4(-9000, -9000, -9000, -9000), 0, 1, false),
        ...
        {
            new TVEPropertyData("_TerrainCategory", "Terrain Settings"),
            ...
            new TVEPropertyData("_TerrainSampleMode54", "Terrain 16 Sampling", -9000, "Planar 1 Triplanar 2 Stochastic 3 Stochastic_Triplanar 4", false),
            ...
            new TVEPropertyData("_TerrainFormMode", "Terrain Form Mode", -9000, "Additive 0 Multiply_And_Additive 1", false),
            new TVEPropertyData("_TerrainFormValue", "Terrain Form Offset", -9000, false, false),
        ...
        List<TVEPropertyData> clippingData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_CutoutGlobalValue", "Cutout Fade Mask", -9000, 0, 1, false, true),
            ...
            new TVEPropertyData("_CutoutElementMode", "Use Atmo Elements", -9000, true),

            new TVEPropertyData("_GlancingCategory", "Glancing Settings"),

            new TVEPropertyData("_GlancingIntensityValue", "Glancing Intensity", -9000, 0, 1, false, false),
            new TVEPropertyData("_GlancingAngleValue", "Glancing Angle", -9000, 0, 8, false, false),
            new TVEPropertyData("_GlancingShadowMode", "Glancing Shadow", -9000, "Off 0 Affect_Shadow_Pass 1", false),

            new TVEPropertyData("_GlancingMultiValue", "Glancing Multi Mask", -9000, 0, 1, false, true),
            new TVEPropertyData("_GlancingNoiseMode", "Glancing Noise Mode", -9000, "Noise_3D 0 Noise_Screen_Space 1", false),
            new TVEPropertyData("_GlancingNoiseTillingValue", "Glancing Noise Tilling", -9000, 0, 100, false, false),
        ...
        List<TVEPropertyData> transformData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_ConformCategory", "Conform Settings"),

            new TVEPropertyData("_ConformInfo", "The Conform features require elements to work. Use Form Surface or Form Height and Form Normal elements for conforming and aligning the objects to terrain surfaces. Please note, the conform effect is only visual and it does not affect the object collision and bounds.", 0, 10, MessageType.Info),

            new TVEPropertyData("_ConformHeightValue", "Conform Height", -9000, 0, 1, false, false),
            new TVEPropertyData("_ConformHeightOffsetMode", "Conform Height Mode", -9000, "NULL", "Freeform_Object_Position 0 Lock_Position_With_Conform 1", false),
            new TVEPropertyData("_ConformHeightOffsetValue", "Conform Height Offset", -9000, false, false),
            new TVEPropertyData("_ConformNormalValue", "Conform Orientation", -9000, 0, 1, false, false),
        ...
        {
            new TVEPropertyData("_MotionCategory", "Motion Settings"),

            new TVEPropertyData("_MotionPushInfo", "The Interaction features require elements to work. Use Flow elements to add interaction and use the Push Mask slider to control the interaction amount per motion layer.", 0, 10, MessageType.Info),
            ...
            new TVEPropertyData("_MotionDistValue", "Motion Details Limit", -9000, 0, 1000, false, false),
            ...
            new TVEPropertyData("_MotionBasePushValue", "Motion Primary Push Mask", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionBaseMaskMode", "Motion Primary Anim Mask", -9000, "Vertex_R 0 Vertex_G 1 Vertex_B 2 Vertex_A 3 Height 4 Sphere 5", false),
            ...
            new TVEPropertyData("_MotionSmallPushValue", "Motion Second Push Mask", -9000, 0, 1, false, false),
            new TVEPropertyData("_MotionSmallMaskMode", "Motion Second Anim Mask", -9000, "Vertex_R 0 Vertex_G 1 Vertex_B 2 Vertex_A 3 Height 4 Sphere 5", false),
            ...
            new TVEPropertyData("_MotionTinyDelayValue", "Motion Leaves Delay", -9000, 0, 1, false, false),
            ...
            new TVEPropertyData("_MotionTinyMaskMode", "Motion Leaves Anim Mask", -9000, "Vertex_R 0 Vertex_G 1 Vertex_B 2 Vertex_A 3 Height 4 Sphere 5", false),
        ...
        List<TVEPropertyData> normalData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_NormalConformInfo", "The Normal Blanket feature requires elements to work. Use Form Surface or Form Normal elements to send global normals to the shaders.", 0, 10, MessageType.Info),
            ...
            new TVEPropertyData("_NormalConformValue", "Normal Conform", -9000, 0, 1, false, false),
            ...
            new TVEPropertyData("_NormalFormValue", "Normal Form Mask", -9000, 0, 1, false, false),
            new TVEPropertyData("_NormalFormMode", "Normal Form Mode", -9000, "Additive 0 Multiply_And_Additive 1", false),
            new TVEPropertyData("_NormalFormValue", "Normal Form Offset", -9000, false, false),
        };
        ...
        List<TVEPropertyData> metaData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_MetaInfo", "The Meta settings are a low fidelity representation of the entire material shading used for HTrace voxelization when the object is not in view or occluded by other objects.", 0, 10, MessageType.Info),

            new TVEPropertyData("_MetaAlbedoTex", "Meta Albedo", null, false),
            ...
            new TVEPropertyData("_MetaMode", "Meta Mode", -9000, "Sync_With_Material 0 Override 1", true),
            new TVEPropertyData("_MetaColor", "Meta Color", new Color(-9000, 0,0,0), true, false),
            new TVEPropertyData("_MetaAlbedoValue", "Meta Albedo", -9000, 0, 1, false, false),

            new TVEPropertyData("_MetaTintingMode", "Meta Tinting Mode", -9000, "Sync_With_Material 0 Override 1", true),
            new TVEPropertyData("_MetaTintingValue", "Meta Tinting Value", -9000, 0, 1, false, false),
            new TVEPropertyData("_MetaDrynessMode", "Meta Dryness Mode", -9000, "Sync_With_Material 0 Override 1", false),
            new TVEPropertyData("_MetaDrynessValue", "Meta Dryness Value", -9000, 0, 1, false, false),
            new TVEPropertyData("_MetaOverlayMode", "Meta Overlay Mode", -9000, "Sync_With_Material 0 Override 1", false),
            new TVEPropertyData("_MetaOverlayValue", "Meta Overlay Value", -9000, 0, 1, false, false),
            new TVEPropertyData("_MetaWetnessMode", "Meta Wetness Mode", -9000, "Sync_With_Material 0 Override 1", false),
            new TVEPropertyData("_MetaWetnessValue", "Meta Wetness Value", -9000, 0, 1, false, false),
            new TVEPropertyData("_MetaCutoutMode", "Meta Cutout Mode", -9000, "Sync_With_Material 0 Override 1", false),
            new TVEPropertyData("_MetaCutoutValue", "Meta Cutout Value", -9000, 0, 1, false, false),
            new TVEPropertyData("_MetaDitherMode", "Meta Dither Mode", -9000, "Sync_With_Material 0 Override 1", false),
            new TVEPropertyData("_MetaDitherValue", "Meta Dither Value", -9000, 0, 1, false, false),
            new TVEPropertyData("_MetaEmissiveMode", "Meta Emissive Mode", -9000, "Sync_With_Material 0 Override 1", false),
...
;
                    ...
                    else
                    {
                        ...
                        else if (allMaterials.Count == 1)
                        {
                            ...
                            for (int i = 0; i < selectedMaterials.Count; i++)
                            {
                                ...
                                TVEUtils.SetImpostorFeatures(oldMaterial, material);
        ...
        {
            motionControl = 0.5f;
            Shader.SetGlobalVector("TVE_MotionParamsEditor", new Vector4(1, 0, 0, 0));
        }
        ...
        void SetEditorWind()
        {
            ...
            Shader.SetGlobalVector("TVE_MotionParamsEditor", new Vector4(mulValue, addValue, motionControl, 1));
        }
    }
}
