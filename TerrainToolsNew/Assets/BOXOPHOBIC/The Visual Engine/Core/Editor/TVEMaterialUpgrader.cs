...
namespace TheVisualEngine
{
    public class TVEMaterialUpgrader : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Material upgrading is required when switching render pipelines or when upgrading to a newer version. Always run the Material Upgrader after all modules are installed and after the custom shaders are re-compiled to make sure all material are upgraded correctly!", MessageType.Info, true);
