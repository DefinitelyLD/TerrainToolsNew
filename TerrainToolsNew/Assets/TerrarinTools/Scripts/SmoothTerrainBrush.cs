...
namespace TerrainTools {
    ...
    public sealed class SmoothTerrainBrush : TerrainBrush {
        ...
        public override void OnBrushDown(IBrushContext context) {
            ...
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.SmoothBrush, "TerrainHeightmapTexture", terrainHeightmapTexture);
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.SmoothBrush, "BrushHeightmapTexture", brushHeightmapTexture);
        ...
        public override void OnBrushUpdate(IBrushContext context) {
            ...
            commandBuffer.DispatchCompute(computeShader, (int)KernelIndicies.SmoothBrush, dispatchSize.x, dispatchSize.y, dispatchSize.z);
        }
    }
}
