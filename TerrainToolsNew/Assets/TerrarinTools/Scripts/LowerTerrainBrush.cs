...
namespace TerrainTools {
    [TerrainBrush]
    public sealed class LowerTerrainBrush : TerrainBrush {
        ...
        public override void OnBrushDown(IBrushContext context) {
            ...
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.LowerBrush, "TerrainHeightmapTexture", terrainHeightmapTexture);
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.LowerBrush, "BrushHeightmapTexture", brushHeightmapTexture);
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.LowerBrush, "BrushMaskTexture", brushShapeTexture);
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.LowerBrush, "OutputBrushHeightmapTexture", outputBrushHeightmapTexture);
        ...
        public override void OnBrushUpdate(IBrushContext context) {
            ...
            commandBuffer.DispatchCompute(computeShader, (int)KernelIndicies.LowerBrush, dispatchSize.x, dispatchSize.y, dispatchSize.z);
        }
    }
}
