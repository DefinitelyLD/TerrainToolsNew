...
namespace TerrainTools {
    public struct TerrainToolsMasker {
        public readonly void MaskHeightmapPass(IBrushContext context, RenderTexture output) {
            ...
            commandBuffer.SetComputeTextureParam(computeShader, (int)KernelIndicies.MaskHeightmap, "HeightmapTexture", output);
